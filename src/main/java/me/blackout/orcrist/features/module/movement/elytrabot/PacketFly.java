...
import me.blackout.orcrist.events.CancellableMoveEvent;
...
public class PacketFly {
    private static final TimerUtils antiKickTimer = new TimerUtils();
    ...
    @EventHandler
    private void onMove(CancellableMoveEvent event) {
        if (!toggled) return;
