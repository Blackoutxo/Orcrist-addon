package me.blackout.orcrist.features.module.movement;
...
public class FlightPlus extends Module {
    public FlightPlus() {
        super(OrcristAddon.Movement, "Flight+", "Better flight.");
    }
    ...
    private void onMove(PlayerMoveEvent event){
        if (mc.player == null && mc.world == null) return;
            ...
            if (flyMode.get().equals(FlightMode.Momentum)){
                ...
                if (mc.options.jumpKey.isPressed() && y == 0) y = ySpeed.get();
                else if (mc.options.sneakKey.isPressed()) y = -ySpeed.get();
